...
var Fetcher = {
     ...
     * By convention, the name is Store.<MyDomain>.<MyStore>, e.g. Store.Finance.PortfolioYQL, Store.Sport.PlayerAPI.
     * The lowercase string of the store name will be used as the config key for storing configs related to this store
     * in the config object tree.
     * @property name
     * @type String
     * @static
     */
    ...
    _sync: function (resource, operation, params, body, context, callback) {
        ...
        if ((typeof window !== 'undefined') && window.fetcherPathPrefix) {
            context.config.xhr = window.fetcherPathPrefix;
        }
